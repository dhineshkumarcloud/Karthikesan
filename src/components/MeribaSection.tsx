...
const cases = [
  { size: "300 ml", pack: "Pack of 12", image: case300 },
  { size: "500 ml", pack: "Pack of 12", image: case500 },
  { size: "1 Litre", pack: "Pack of 9", image: case1l },
  { size: "2 Litre", pack: "Pack of 9", image: case2l },
];

const MeribaCase = ({ image, size, pack, index }: { image: string; size: string; pack: string; index: number }) => {
  ...
  return (
    ...
    >
      ...
      <div className="text-center mt-5">
        ...
        <p className="text-xs text-muted-foreground mt-1 uppercase tracking-wider">{pack}</p>
      </div>
    </div>
  );
};
